import { customErrorHandler } from '../../../middleware/error.middleware.js';
...
let users = [
  new UserModel(1, 'Md Adnan', 'adnan@gmail.com', 'adnan123'),
  new UserModel(2, 'Shad', 'shad@gmail.com', 'shad123'),
];
